...
public class RegistrationController {
  ...
  private void sendRegistrationEmail(String email) {
    try {
      ...
      message.setFrom("sahanalakshminarayanan@gmail.com"); // Use a professional sender email
      message.setTo(email);
      message.setSubject("Welcome to NextEdge Learning – Empowering Your Path to Knowledge!");
